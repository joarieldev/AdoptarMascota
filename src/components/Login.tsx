                ...
                <div className="p-8 md:p-9">
                  <form onSubmit={handleSubmit} className="space-y-5" action="#">
                    <div>
                      ...
                      <input onChange={handleChange} type="text" id="user" name="user" className="bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="juan, william32" required />
                    </div>
                    <div>
                      <label htmlFor="password" className="inline-block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contraseña</label>
                      <input onChange={handleChange} type="password" name="password" id="password" placeholder="••••••••" className="bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-600 dark:placeholder-gray-400 dark:text-white" required />
                    </div>
                    <div>
