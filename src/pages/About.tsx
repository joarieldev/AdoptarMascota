...
export const About = () => {
  return (
    <Section>
        <article className='flex flex-col justify-center items-center w-full gap-5'>
          <p className='dark:text-gray-50 md:w-[510px] text-pretty font-thin text-center max-md:text-base text-lg xl:text-xl max-sm:px-1'>
            <span className='font-medium tracking-wide block'>¡Adopta una mascota y cambia su vida para siempre!</span>
